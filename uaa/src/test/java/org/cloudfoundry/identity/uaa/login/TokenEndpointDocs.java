...
class TokenEndpointDocs extends AbstractTokenMockMvcTests {
    ...
    void getTokenUsingAuthCodeGrant() throws Exception {
        ...
        mockMvc.perform(postForToken)
                ...
                .andDo(document("{ClassName}/{methodName}", preprocessResponse(prettyPrint()), headerFields, queryParameters, responseFields));
    }
    ...
    void getTokenUsingClientCredentialGrant() throws Exception {
        ...
        mockMvc.perform(postForToken)
                .andDo(document("{ClassName}/{methodName}", preprocessResponse(prettyPrint()), queryParameters, responseFields));
    }
    ...
    void getTokenUsingClientCredentialGrantWithAuthorizationHeader() throws Exception {
        ...
        mockMvc.perform(postForToken)
                .andDo(document("{ClassName}/{methodName}", preprocessResponse(prettyPrint()), queryParameters, requestHeaders, responseFields));
    }
