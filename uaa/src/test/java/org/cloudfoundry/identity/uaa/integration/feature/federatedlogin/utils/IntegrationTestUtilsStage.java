...
public class IntegrationTestUtilsStage {
    ...
    public static void assertSupportsZoneDNS() {
        ...
        ).forEach(IntegrationTestUtilsStage::assertLoopback);
    }
    ...
    private static IdentityZone createZoneOrUpdateSubdomain(RestTemplate client,
        ...
        ResponseEntity<String> zoneGet = client.getForEntity(url + "/orchestrator/zones/{id}", String.class, id);
    ...
    public static String getZoneAdminToken(String baseUrl, ServerRunning serverRunning, String zoneId) {
        ...
        String groupId = IntegrationTestUtilsStage.findGroupId(adminClient, baseUrl, groupName);
        ...
        return IntegrationTestUtilsStage.getAccessTokenByAuthCode(serverRunning,
