...
public class OrchestratorZoneServiceTests {
    ...
    public static final String ZONE_NAME_WITH_EMPTY = "";
    public static final String UAA_DASHBOARD_URI = "http://localhost/dashboard";
    public static final String CLIENT_ID = "client-id";
    public static final String ZONE_AUTHORITIES = "zone-authorities";
    public static final String GRANT_TYPES = "grant-types";
    public static final String RESOURCE_IDS = "resource-ids";
    public static final String SCOPES = "scopes";
    public static final String UAA_CLIENT_ID = "uaa-client-id";
    ...
    private String uaaDashboardUri;
    ...
    public void beforeEachTest() {
        ...
        zoneService = new OrchestratorZoneService(zoneProvisioning, idpProvisioning, groupProvisioning,
                                                  ...
                                                  UAA_DASHBOARD_URI, CLIENT_ID, ZONE_AUTHORITIES, GRANT_TYPES,
                                                  RESOURCE_IDS, SCOPES, UAA_CLIENT_ID, DOMAIN_NAME);
    ...
    @Test
    public void testGetOrchestratorZoneDetails() {
        IdentityZone identityZone = buildIdentityZone();
        when(zoneProvisioning.retrieveByName(any())).thenReturn(identityZone);
        OrchestratorZoneResponse zone = zoneService.getOrchestratorZoneDetails(ZONE_NAME);
        assertNotNull(zone);
        ...
        assertEquals(zone.getConnectionDetails().getDashboardUri(), UAA_DASHBOARD_URI);
    ...
    @Test
    public void testGetOrchestratorZoneDetails_NotFound() {
        ...
        ZoneDoesNotExistsException exception =
            Assertions.assertThrows(ZoneDoesNotExistsException.class, () ->
                                        zoneService.getOrchestratorZoneDetails("random-string"),
                                    "Not found exception not thrown");
        assertTrue(exception.getMessage().contains("Zone not available."));
    }

    @Test
    public void testCreateOrchestratorZone() throws OrchestratorZoneServiceException {
        ...
        zoneService.createOrchestratorZone(zoneRequest);
    ...
    @Test
    public void testCreateOrchestratorZoneDetails_AccessDeniedException() {
    ...
    @Test
    public void testCreateOrchestratorZone_AdminClientSecretEmptyFailWithException() {
    ...
    @Test
    public void testCreateOrchestratorZone_SubDomainWithBlankFailWithException() {
        OrchestratorZoneRequest zoneRequest = getOrchestratorZoneRequest(ZONE_NAME, ADMIN_CLIENT_SECRET,
    ...
    public void testCreateOrchestratorZone_SubDomainWithSpaceOrSpecialCharFailWithException(String subDomain) {
        OrchestratorZoneRequest zoneRequest = getOrchestratorZoneRequest(ZONE_NAME, ADMIN_CLIENT_SECRET,
                                                                         subDomain);
    ...
    @Test
    public void testCreateOrchestratorZone_checkOrchestratorZoneExists() {
        OrchestratorZoneRequest zoneRequest = getOrchestratorZoneRequest(ZONE_NAME, ADMIN_CLIENT_SECRET,
                                                                         SUB_DOMAIN_NAME);
