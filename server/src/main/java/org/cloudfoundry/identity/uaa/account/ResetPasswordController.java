...
public class ResetPasswordController {
    ...
    public String forgotPasswordPage(Model model,
        ...
        if (!identityZoneManager.getCurrentIdentityZone().getConfig().getLinks().getSelfService().isSelfServiceResetPasswordEnabled()) {
            return handleSelfServiceDisabled(model, response, "error_message_code", "self_service_reset_password_disabled");
        }
