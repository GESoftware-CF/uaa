...
public class JwtBearerAssertionAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(final HttpServletRequest request, final HttpServletResponse response,
        ...
        try {
            if (grantType.equals(OauthGrant.JWT_BEARER)) {
                ...
                authentication = authenticateJwtAssertion(request);
    ...
    private Authentication authenticateJwtAssertion(final HttpServletRequest request) {
        ...
        if (this.enforceClientAssertionHeader) {
            return tokenAuthenticator.authenticate(request.getParameter("assertion"),
